    ...
    <div className="glass-dark rounded-xl p-3 lg:p-5 h-full flex flex-col shadow-2xl border border-slate-700/50">
      ...
      <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-2">
        <div className="metric-card">
          ...
          <div className="text-sm lg:text-base font-bold text-cyan-400 tabular-nums">
        ...
        <div className="metric-card">
          ...
          <div className="text-sm lg:text-base font-bold text-rose-400 tabular-nums">
        ...
        <div className="metric-card">
          ...
          <div className="text-sm lg:text-base font-bold text-purple-400 tabular-nums">
        ...
        <div className="metric-card">
          ...
          <div className="text-sm lg:text-base font-bold text-white tabular-nums">
      ...
      <div className="mt-2 grid grid-cols-3 gap-2">
        <div className="metric-card bg-emerald-500/10 border border-emerald-500/30">
          <div className="text-xs text-emerald-400/80">Delivered</div>
          <div className="text-sm font-bold text-emerald-400 tabular-nums">
            {energyPositive.toFixed(2)}
          </div>
          <div className="text-xs text-emerald-600">J</div>
        </div>
        <div className="metric-card bg-orange-500/10 border border-orange-500/30">
          <div className="text-xs text-orange-400/80">Returned</div>
          <div className="text-sm font-bold text-orange-400 tabular-nums">
            {energyNegative.toFixed(2)}
          </div>
          <div className="text-xs text-orange-600">J</div>
        </div>
        <div className={`metric-card border ${energyNet >= 0 
          ? 'bg-emerald-500/10 border-emerald-500/30' 
          : 'bg-orange-500/10 border-orange-500/30'}`}>
          <div className={`text-xs ${energyNet >= 0 ? 'text-emerald-400/80' : 'text-orange-400/80'}`}>
            Net
          </div>
          <div className={`text-sm font-bold tabular-nums ${energyNet >= 0 ? 'text-emerald-400' : 'text-orange-400'}`}>
            {energyNet >= 0 ? '+' : ''}{energyNet.toFixed(2)}
          </div>
          <div className={`text-xs ${energyNet >= 0 ? 'text-emerald-600' : 'text-orange-600'}`}>
            J
          </div>
        </div>
      </div>

      <div className="mt-2 text-xs text-gray-400 flex flex-wrap items-center justify-center gap-2 lg:gap-4">
        ...
        {side === 'primary' && powerCalcData.powerMagnetizing && (
          <div className="flex items-center gap-1">
            <div className="w-3 h-0.5 bg-orange-400 rounded" style={{ borderTop: '2px dashed #f59e0b' }}></div>
